function cargarComponentes(idMotor, idMarco, idControl, idBateria, idCamara, idGps){
  ...
  var myjson =$.getJSON("json/datosDron.json", function(json) {
      ...
      var bateria = json.baterias[idBateria];
